from rolo.dsl.api import DslCompileRequest, DslCheckRequest
...
def test_service_check_and_compile(tmp_path):
    ...
    compiled = service.compile(DslCompileRequest(dsl=value(), dsl_digest=checked.dsl_digest, context=context(), context_digest="sha256:c", target_fingerprint="fp"), tmp_path)
