...
def test_resolver_accepts_observed_reference():
    assert resolve_evidence(doc(), {"robot_id": "r", "evidence_digest": "sha256:e", "target_fingerprint": "fp", "evidence_refs": ["route:/state"]}).ok


def test_resolver_blocks_forged_reference():
    report = resolve_evidence(doc(), {"robot_id": "r", "evidence_digest": "sha256:e", "target_fingerprint": "fp", "evidence_refs": []})
...
def test_resolver_blocks_cross_target_context():
    report = resolve_evidence(doc(), {"robot_id": "other", "evidence_digest": "sha256:e", "target_fingerprint": "fp", "evidence_refs": ["route:/state"]})
