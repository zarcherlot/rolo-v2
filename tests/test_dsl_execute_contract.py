...
def test_source_bundle_schema_version_is_frozen():
    try:
        SourceBundleManifest.model_validate(
            {
                "schema_version": "rolo-source-bundle/v2",
        ...
        return
    raise AssertionError("unsupported source bundle schema must be rejected")
