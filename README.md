...
- **Robot Knowledge Base**：RKB 设计、Probe 审计和[修订后的可执行开发计划](docs/adapt/ROLO_V2_ROBOT_KNOWLEDGE_BASE_EXECUTION_PLAN_ZH.md)见[架构说明](docs/architecture/ROBOT_KNOWLEDGE_BASE_FOR_AGENT_DEBUGGING_ZH.md)、[审计报告](docs/review/ROLO_V2_PROBE_KNOWLEDGE_BASE_AUDIT_ZH.md)和[开发计划评审](docs/review/ROLO_V2_RKB_DEVELOPMENT_PLAN_REVIEW_ZH.md)。
...
- **配置与专家 CLI**：字段和细粒度命令见[配置说明](docs/setup/CONFIGURATION.md)与 [Probe 短流程](docs/getting-started/ADAPT_SHORT_JOURNEY.md)。
