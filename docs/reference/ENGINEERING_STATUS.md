<!-- status: active; authority: reference; owner: rolo maintainers; last_reviewed: 2026-09-04; last_synced_commit: c05ab27e62b4d61351d99a711be930f6a7abc27b -->
...
| FEAT-MVP-ROTATION-TRACE | PARTIAL | E3 | `app.base.rotate` supervised field execution | `src/rolo/mvp/trace.py`; `src/rolo/mvp/ros_binding.py`; `src/rolo/mvp/bounded_twist.py`; `src/rolo/product_cli.py` | `tests/test_mvp_rotation.py`; `tests/test_mvp_rotation_execution.py`; MentorPi 360° evidence | 单次 360° 真机执行已通过；通用 binding dispatcher、Trace artifact、真机恢复和 10-case Certify 仍待完成 |
